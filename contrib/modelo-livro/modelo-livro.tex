...
% compilação de fontes
  ...
  % para xelatex: para ser possível utilizar as fontes do sistema. se for usar pdflatex, comente (ou apague) as linhas abaixo:
...
%   \setmonofont[Scale=MatchLowercase]{Consolas} % fonte monoespaçada
  ...
  % pdflatex: se for utilizar pdflatex, descomente as linhas abaixo.
\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
%escolha só um pacote de fontes:
