...
% abntex2-modelo-livro.tex, abntex2-modelo-livro.bib,
...
% Margens do documento %% (margens do abntex2 não combinam nem com A5 nem com estilos de capítulo da classe memoir.)
...
seria real se não fosse o trabalho de Youssef Cherem, a quem o responsável atual
pelo projeto, Lauro César Araujo, agradece incondicionalmente.
\end{agradecimentos}
% ---
...
a servir como modelo para composição e diagramação de livros e folhetos em \LaTeX. Ele
foi concebido para servir de base para elaboração de livros baseados na norma
ABNT NBR 6029:2006 \emph{Informação e documentação - Livros e folhetos -
Apresentação}.
Essa norma não estabelece parâmetros tão rígidos quanto a ABNT NBR 14724:2011,
para trabalhos acadêmicos, e segue, de certa forma, o design usual de
livros\footnote{Para facilitação da compreensão de termos técnicos, ver a Tabela
...
Em geral, qualquer outra classe que contemple o formato de livros poderia
ser utilizada. A formatação de geral dos capítulos, margens, tamanho de página,
fontes, etc., segundo a norma ABNT em questão, pode ser modificada pelo usuário
à vontade.

Porém, este modelo foi composto com a classe \texttt{abntex2.cls} com o intuito
...
% ------------------------------------------------------------
\chapter{Outro exemplo de capítulo}
% ------------------------------------------------------------
...
\bibliography{abntex2-modelo-livro} % insere o arquivo de bibliografia (.bib)
