...
o estilo bibliográfico alfabético (sistema autor-data). Este documento é parte
integrante da suíte \abnTeX2 e é um complemento do documento ``Manual de uso dos
estilos bibliográficos do pacote \textsf{abntex2cite}: estilos \textsf{bibtex}
compatíveis com a ABNT NBR 6023:2000''.
...
\cite{abnt-bibtex-doc}). Embora \emph{todas} as `normas' da ABNT
...
Veja mais informacões na \autoref{tabela-opcoes} e em \cite{abnt-bibtex-doc}.
...
\subsection{Referências em notas de roda-pé}
