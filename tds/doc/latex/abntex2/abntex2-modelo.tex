%% abtex2-modelo.tex, v 1.2 2013/01/09 laurocesar
...
Este documento exemplifica o uso da classe \textsf{abntex2}. A expressão
``Modelo canônico'' é utilizada para indicar que \abnTeX~não é modelo específico de
...
Este exemplo deve ser utilizado como complemento dos manuais do \abnTeX~e
\cite{abntex2classe,abntex2cite,abntex2cite-alf}, da classe \textsf{memoir}
\cite{memoir}. Leia também do código-fonte deste documento que está lendo agora.

Esperamos, sinceramente, que a sua contribuição acadêmica tenha ainda mais
qualidade com uso do \abnTeX.
...
% Capitulo 1
% ----------------------------------------------------------
\chapter{Exemplos de comandos}\label{cap_exemplos}
...
também seja identado, como é o caso deste documento. Para isso, apenas inclua o
