%% abtex2-modelo-relatorio-tecnico.tex, v 1.3 2013/01/13 laurocesar
...
%%
%% 2013.1.13 11h29 laurocesar
%%  Cria o modelo
%%

% ------------------------------------------------------------------------
% ------------------------------------------------------------------------
% Modelo de Relatório Técnico/Acadêmico utilizando abnTeX2, 
% conforme ABNT NBR 10719:2011
% ------------------------------------------------------------------------ ------------------------------------------------------------------------
%
...
% ---
% Anverso da folhad e rosto:
% ---

Conforme a ABNT NBR 10719:2011, seção 4.2.1.1.1, o anveso da folha de rosto deve
conter:
...
O agradecimento principal é direcionado a Youssef Cherem, Exemplo de Formulário de Identificação (
p. \pageref{anexonorma}).
...
Este documento e seu código-fonte devem ser utilizados como exemplo de
referência de uso da classe \textsf{abntex2} e do pacote \textsf{abntex2cite}.
O documento também exemplifica a elaboração de relatórios técnicos e/ou
científicos produzidos conforme ABNT NBR 10719:2011 \emph{Informação e
documentação - Relatório técnico e/ou científico - Apresentação}.

A expressão ``Modelo canônico'' é utilizada para indicar que \abnTeX~não é
modelo específico de trabalho relatório técnico e/ou científico de nenhuma
universidade ou instituição, mas que implementa tão somente os requisitos das
normas da ABNT.
...
forma, ele é o último elemento pós-textual do relatório.
