%% abtex2.tex, v 1.2 2013/01/06 laurocesar
...
\title{\textbf{A classe \textsf{abntex2}}: \\ \Large{Modelo canônico de
trabalhos acadêmicos brasileiros \\compatível com as normas ABNT NBR 14724:2011, 
ABNT NBR 6024:2012 e outras}}
...
6024:2012. A \autoref{sec-introducao} contém a lista completa de normas
observadas pela classe.
...
Um exemplo de uso da classe descrita neste manual pode ser consultado em
\citeonline{abntex2modelo}. O documento indicado trata-se de um ``Modelo
Canônico'', ou seja, de um modelo de trabalho acadêmico que não é específico de nenhuma
universidade ou instituição, mas que implementa os requisitos das normas da
ABNT, e apenas eles.
...
esses elementos a documentação e o Modelo canônico de trabalho acadêmico, todos
distribuídos de forma conjunta.}:
