...
\usepackage[subentrycounter,seeautonumberlist]{glossaries}% Glossario
% ---
...
exemplifica o uso de um termo no início da frase. \Gls{abntex2} é escrito em
\gls{latex}.''
...
Opcionalmente, incorpore todas as palavras de uma única vez com o comando:
