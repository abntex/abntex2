...
\usepackage{abntex2cite}
    ...
    Verifique a documentação do pacote
    \texttt{url}.\footnote{\url{http://texdoc.net/pkg/url}}

\end{description}

A ordem de carregamento dos pacotes é importante na medida em que
evita erros do tipo ``option clash''. Caso os erros permaneçam
(provavelmente causados pelo carregamento do pacote em questão por um
terceiro pacote), o pacote deve ser carregado com o comando
\verb+\PassOptionsToPackage{<options>}{<package>}+:
...
\begin{verbatim}
\PassOptionsToPackage{hyphenibreaks}{breakurl}
\end{verbatim}
