...
% ---
\subsection{Hifenização e alterações no pacote \textsf{babel}}
\label{babel}
% ---

Para usar as diferentes hifenizações, inclua nas opções do documento o nome dos
idiomas que o texto contém. Por exemplo:
...
\textsf{babel} para atender a requisitos da ABNT NBR 14724:2011, conforme
\autoref{tab-babel}.
...
A \autoref{babel} aborda a macro |otherlanguage*|, responsável pela hifenização
