...
%%  Descreve macros \IBGEtab e \legenda
%%
...
macro 
|\IBGEtab|\marg{Nome e rótulo da tabela}\marg{Conteúdo da tabela}\marg{Conteúdo da legenda}.

Nome e rótulo devem ser criados com |\caption|\margs{Nome do objeto} e
|\label|\marg{Nome do rótulo}, respectivamente. O conteúdo da tabela pode ser
criada com os ambientes |tabular|, |table|, |longtable| ou mesmo ser uma figura
importada no ambiente |figure|. A legenda pode ser criada com |\fonte| ou com a
...
|\fonte|\marg{Descrição da fonte da tabela ou imagem}, que imprime o conteúdo do
primeiro argumento antecedido da expressão ``Fonte: '' alinhado conforme
requisitos do IBGE. A macro |\fonte| pode ser usada no interior de figuras ou de
outros ambientes.
