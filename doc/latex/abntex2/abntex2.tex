...
\subsubsection{Traduções de nomes padronizados}
\label{sec-babel-traducoes}

Algumas alterações foram realizadas nos nomes padronizados pelo pacote
\textsf{babel} para atender a requisitos da \citeonline{NBR14724:2011} e
...
% ---
\subsection{Macros de dados do documento}\label{sec-macrosdados}
% ---
...
de alterações realizadas na \autoref{sec-babel-traducoes}. As remissões internas
