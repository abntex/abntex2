...
% ---
\subsection{A classe \textsf{abntex} como extensão de \textsf{memoir}}
% ---
...
estão disponíveis, como por exemplo, |12pt,openright,twoside,a4paper,artile|.
...
obtida com |\part| não numerada. A variante |\anexosname*| não inclui a divisão
