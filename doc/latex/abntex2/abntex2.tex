...
localmente ajustado através da mabro |\IBGEtabfontsize|. A norma diz que o
contéudo de tabelas deve ser em fonte reduzida, assim, por padrão, a classe 
faz |\IBGEtabfontsize| como |\ABNTEXfontereduzida|. Para uma adequação às 
normas da intituição este tamanho pode ser modificado via  
|\renewcommand|\marg{|\IBGEtabfontsize|}{tamanho de fonte desejada}.
