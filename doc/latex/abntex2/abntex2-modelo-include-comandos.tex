...
Text in English language. This environment switches all language-related
definitions, like the language specific names for figures, tables etc. to the
other [...]
\end{citacao}
\end{verbatim}
...
% ---
\section{Ajuste no espaçamento entre os capítulos e o texto}
% ---
...
\begin{verbatim}
\chapter{Título de um anexo ou apêndice muito longo, com mais de duas linhas, 
que pode ocasionar um problema de espaçamento}
\phantom{x}
