...
%%
%% 2013.1.16 17h42 laurocesar
%%  Adiciona explicação do comando \include
%%
...
% ---
\section{Inclusção de outros arquivos}\label{sec-include}
% ---

É uma boa prática dividir o seu documento \LaTeX em diversos arquivos, e não
apenas escrever tudo em um único documento. Para isso, utilize o comando:

\begin{verbatim}
   \include{documento-a-ser-incluido}      % sem a extensão .tex
\end{verbatim}

Isso foi utilizado neste documento.
