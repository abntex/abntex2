...
\paragraph{Esta é uma subseção de quinto nível}\label{sec-exemplo-paragrafo}

Esta é uma seção de quinto nível. Ela é produzida com o comando de parágrafo:

\begin{verbatim}
\paragraph{Esta é uma subseção de quinto nível}\label{sec-exemplo-paragrafo}
\end{verbatim}

\paragraph{Esta é outra subseção de quinto nível}\label{sec-exemplo-paragrafo-outro}
