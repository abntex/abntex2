%% $Id: abnt-bibtex-doc.tex,v 1.44 2004/03/23 17:35:47 mvsfrasson Exp $
...
%%
%% $Log: abnt-bibtex-doc.tex,v $
%% Revision 1.44  2004/03/23 17:35:47  mvsfrasson
%%
%%
...
A `norma' 6023/2000\cite{NBR6023:2000} da ABNT é uma droga.
...
porque não se deveria usar, em nenhuma circunstância, a `norma' 6023
então leia o restante do texto.
...
\noindent\begin{minipage}[t]{10cm}\latex{\small}\begin{verbatim}
...
\bibliography{abnt-nrj,abnt-bibtex-doc,abntex-doc,abnt-6023-2000,normas,abnt-test}
