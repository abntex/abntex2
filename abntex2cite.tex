...
%%  Alteração da classe do documento e reestruturação geral
...
\title{Manual de uso dos estilos bibliográficos \textsf{abntex2-alf.bst} e
\textsf{abntex2-num.bst}: estilos bibtex compatíveis com a ABNT NBR 6023:2000 \\
Versão \Versao$Revision: 1.44 $}
\date{\toady}
%end{latexonly}

\begin{htmlonly}
\title{Manual de uso dos estilos bibliográficos \textsf{abnt-alf.bst} e
\textsf{abnt-num.bst}: estilos bibtex compatíveis com a ABNT NBR 6023:2000 \\
Versão \Versao$Revision: 1.44 $}
...
\textsf{bibtex} compatíveis com a ABNT NBR 6023:20000.

A classe \textsf{abntex2} é detalhada em manual próprio.

\section{Créditos aos autores originais}

Este documento é derivado do documento \emph{Estilo bibtex compatível com a
`norma' 6023 da ABNT - Versão $ 1.44 $} escrito por G. Weber e atualizado por M.
V. Frasson no âmbito do projeto \abnTeX hospedado em
\url{http://codigolivre.org.br/projects/abntex}\footnote{O documento original
pode ser lido em
...
O estilo \textsf{abntcite} ainda disponibiliza os comandos \verb+\citeyear+,
...
Veja documento específico Ref.~\citeonline{abnt-bibtex-alf-doc}.
