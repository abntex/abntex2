...
Este manual faz parte da suíte \abnTeX2. Para referências a pacote de citações
...
\begin{description}
  \item[ABNT NBR 6023:2000]\footnote{A versão corrente da ABNT NBR 6023 é a
  6023:2002. Porém, até este momento, o \abnTeX2 traz os estilos compatíveis com a versão anterior da norma.
A atualização dos estilos é uma das etapas posterioras do projeto.} Informação e documentação -
...
\subsection{O que o \abnTeX2 traz de novo em relação ao \abnTeX\ original?}

A suíte \abnTeX2 é composta por três elementos principais: 
...
outros pequenos aperfeiçoamentos. Para referências a pacote de citações
\textsf{abntex2cite}, consulte \cite{abntex2cite} e \cite{abntex2cite-alf}.
...
incompatibilidade mútua entre as versões e você pode ter as duas versões do
\abnTeX\ instaladas simultaneamente no mesmo computador. Desse modo, documentos
...
Com base nesse manual você provavelmente não terá dificuldades em converter os
trabalhos escritos em \abnTeX\ original para o novo \abnTeX2.
...
\bibliography{references/abntex-doc}
% ------
