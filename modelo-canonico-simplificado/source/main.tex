...
% Resumo em inglês {título do resumo}{palavras chaves}
% \begin{resumo}{Abstract}{latex, abntex, text editing}
%  This is the english abstract.
% \end{resumo}

% Resumo em francês {título do resumo}{palavras chaves}
% \begin{resumo}{Résumé}{latex, abntex, l'édition de texte}
%  Ceci est le résumé français.
% \end{resumo}

% Resumo em espanhol {título do resumo}{palavras chaves}
